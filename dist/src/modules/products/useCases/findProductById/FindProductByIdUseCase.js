...
var FindProductByIdUseCase = /** @class */ (function () {
    function FindProductByIdUseCase(repository) {
        this.repository = repository;
    }
    FindProductByIdUseCase.prototype.execute = function (id) {
    ...
    FindProductByIdUseCase = __decorate([
