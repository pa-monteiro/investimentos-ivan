...
var UsersRepositoryInMemory = /** @class */ (function () {
    ...
    UsersRepositoryInMemory.prototype.findByUserIdProducts = function (id) {
    ...
    UsersRepositoryInMemory.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
    ...
    UsersRepositoryInMemory.prototype.updateById = function (id, _a) {
        var deadline = _a.deadline, email = _a.email, name = _a.name;
        return __awaiter(this, void 0, void 0, function () {
            var user;
    ...
    UsersRepositoryInMemory.prototype.listAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    UsersRepositoryInMemory.prototype.removeIds = function (ids) {
        return __awaiter(this, void 0, void 0, function () {
            var users;
            return __generator(this, function (_a) {
                users = this.users.filter(function (u) { return !ids.includes(u.id); });
                this.users = users;
                return [2 /*return*/];
            });
        });
...
exports.default = UsersRepositoryInMemory;
